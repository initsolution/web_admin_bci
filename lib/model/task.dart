...
class Task {
  ...
  factory Task.fromMap(Map<String, dynamic> map) {
    return Task(
      ...
      submitedDate: map['submitedDate'] != null ? map['submitedDate'] as String : null,
      verifiedDate: map['verifiedDate'] != null ? map['verifiedDate'] as String : null,
      status: map['status'] != null ? map['status'] as String : null,
      type: map['type'] != null ? map['type'] as String : null,
      towerCategory: map['towerCategory'] != null ? map['towerCategory'] as String : null,
      makerEmployee: map['makerEmployee'] != null ? Employee.fromMap(map['makerEmployee'] as Map<String,dynamic>) : null,
      verifierEmployee: map['verifierEmployee'] != null ? Employee.fromMap(map['verifierEmployee'] as Map<String,dynamic>) : null,
      site: map['site'] != null ? Site.fromMap(map['site'] as Map<String,dynamic>) : null,
    );
  }

  @override
  String toString() {
    return 'Task(createdDate: $createdDate, submitedDate: $submitedDate, verifiedDate: $verifiedDate, status: $status, type: $type, towerCategory: $towerCategory, makerEmployee: $makerEmployee, verifierEmployee: $verifierEmployee, site: $site)';
  }
